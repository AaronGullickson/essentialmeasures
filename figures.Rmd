...
anc.big[,10:14] <- anc.big[,10:14]*scale2
anc.big.byyear$scale <- 1/(-1*log(1/7,2))
anc.big.byyear$scale[anc.big.byyear $year<2000] <- 1/(-1*log(1/6,2))
anc.big.byyear[,11:15] <- anc.big.byyear[,11:15]*anc.big.byyear$scale
```
